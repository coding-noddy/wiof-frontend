export const FOOD_ITEMS = [
  ...
  { name: "Venison & Elk", value: 6 },
  { name: "Processed Cereals", value: 6 },
  { name: "White Rice", value: 6 },
  { name: "Semolina", value: 6 },
  { name: "Wheat Bran", value: 6 },
  { name: "White Rice & White Flour", value: 6 },
  ...
  { name: "Processed Maple Syrup", value: 6 },
  { name: "Sulphured Molasses", value: 6 },
  ...
  { name: "Canola, Corn & Sunflower Oil", value: 7 },
  ...
  { name: "Fresh Guava & Sapote", value: 8 },
  ...
  { name: "Millet Spelt & Quinoa", value: 8 },
  ...
  { name: "Onions & Leeks", value: 9 },
  { name: "Rutabagas", value: 9 },
  ...
  { name: "Wheatgrass, Lemon & Other Green Grasses", value: 10 },
  ...
  { name: "Blended Green Grass Drinks", value: 10 },
  { name: "Fresh Lemon", value: 10 },
  { name: "Raw Brussels Sprouts", value: 10 },
  ...
  { name: "Tofu", value: 8 },
  { name: "Tempeh", value: 8 },
  { name: "Chicken Breast", value: 6 },
  { name: "Chicken Wings", value: 5 },
  { name: "Turkey Breast", value: 6 },
  { name: "Lamb", value: 5 },
  { name: "Shrimp", value: 6 },
  { name: "Prawns", value: 6 },
  { name: "Crab", value: 5 },
  { name: "Sardines", value: 6 },
  { name: "Mackerel", value: 6 },
  { name: "Mozzarella Cheese", value: 6 },
  { name: "Cheddar Cheese", value: 5 },
  { name: "Parmesan Cheese", value: 5 },
  { name: "Greek Yogurt", value: 6 },
  { name: "Skim Milk", value: 7 },
  { name: "Whole Milk", value: 7 },
  { name: "Oat Milk", value: 7 },
  { name: "Coconut Milk", value: 8 },
  { name: "Avocado", value: 9 },
  { name: "Lemon Juice", value: 10 },
  { name: "Lime", value: 10 },
  { name: "Dragon Fruit", value: 9 },
  { name: "Lychee", value: 8 },
  { name: "Jackfruit", value: 8 },
  { name: "Pomegranate Juice", value: 6 },
  { name: "Cherry", value: 8 },
  { name: "Mulberries", value: 9 },
  { name: "Guava", value: 8 },
  { name: "Coconut", value: 8 },
  { name: "Capsicum", value: 8 },
  { name: "Asparagus", value: 9 },
  { name: "Broccolini", value: 9 },
  { name: "Avocado Leaves", value: 9 },
  { name: "Celeriac", value: 8 },
  { name: "Beet Greens", value: 10 },
  { name: "Collard Greens", value: 10 },
  { name: "Arugula", value: 10 },
  { name: "Bok Choy", value: 10 },
  { name: "Swiss Chard", value: 10 },
  { name: "Brown Rice", value: 7 },
  { name: "White Rice", value: 6 },
  { name: "Bulgur", value: 8 },
  { name: "Farro", value: 8 },
  { name: "Couscous", value: 7 },
  { name: "Amaranth", value: 9 },
  { name: "Cashews", value: 7 },
  { name: "Macadamia Nuts", value: 8 },
  { name: "Chia Seeds", value: 9 },
  { name: "Hemp Seeds", value: 9 },
  { name: "Watermelon Seeds", value: 8 },
  { name: "Dark Chocolate", value: 6 },
  { name: "Milk Chocolate", value: 5 },
  { name: "Cheesecake", value: 5 },
  { name: "Brownies", value: 4 },
  { name: "Cookies", value: 4 },
  { name: "Donuts", value: 4 },
  { name: "Espresso", value: 5 },
  { name: "Cappuccino", value: 6 },
  { name: "Latte", value: 6 },
  { name: "Black Coffee", value: 5 },
  { name: "Cold Brew Coffee", value: 5 },
  { name: "Energy Drinks", value: 4 },
  { name: "Coconut Water", value: 8 },
  { name: "Sparkling Water", value: 6 },
  { name: "Chapati", value: 7 },
  { name: "Roti", value: 7 },
  { name: "Naan", value: 6 },
  { name: "Paratha", value: 5 },
  { name: "Idli", value: 7 },
  { name: "Dosa", value: 6 },
  { name: "Sambar", value: 8 },
  { name: "Poha", value: 7 },
  { name: "Upma", value: 7 },
  { name: "Khichdi", value: 8 },
  { name: "Biryani", value: 5 },
  { name: "Dal", value: 8 },
  { name: "Rajma", value: 7 },
  { name: "Chole", value: 7 },
  { name: "Paneer Butter Masala", value: 5 },
  { name: "Pizza", value: 4 },
  { name: "Burger", value: 4 },
  { name: "Hot Dog", value: 4 },
  { name: "Chicken Nuggets", value: 4 },
