export const aboutUsData = [
  ...
  },
  {
    ...
    "bio": "Amrita is a software engineer by profession and has contributed to the UX of WIOF. She is passionate about animal welfare and is ready to help out dogs in distress. She has rescued many strays, ensuring that they end up in good homes. She participates in a lot of environmental events and volunteers for animal shelters. She is a naturally creative person who believes in finding environmentally sustainable solutions for everyday living. In her free time, she creates artful jewellery with her family at PrettyKnotts to fund her various animal rescues.",
  ...
  },
  {
    ...
    "bio": "Raj Maru has been an Animal Rescuer for 7+ years and an Animal Liberation Activist. Certified from WVS Ooty for vaccinating animals and assisting surgeries, he routinely rescues, treats and fosters injured animals. A budding environmentalist, Raj is an IT Professional, and an ethical vegan for more than 2 years he firmly believes 'Hands that help are better than lips that pray'",
  ...
  },
  {
    ...
    "bio": "Divya Chawla is an HR professional turned content creator and trainer who shares her passion with the WIOF team for making profound changes in saving the planet. She is deeply interested in spirituality , healing sciences , Sustainability and environmental issues which further makes her committed towards creating persuasive content for the community to partake in this vital movement. She has contributed to the research and blog content contribution of the Earth Page.",
  ...
  },
  {
    ...
    "bio": "Krishna is a civil engineer by education and a software developer by profession. An ex-infoscion, he currently is working in Cap Gemini as a SAP Developer. He has written blogs on Water Conservation for WIOF and conducted interviews in Baroda with some environmentally conscious people for WIOF.",
